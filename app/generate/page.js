                ...
                <div className='flex flex-col gap-5 my-8'>
                    ...
                    <div className="item">
                        ...
                        {links && links.map((item, index) => {
                            return <div key={index} className='mx-4'>
                                <input value={item.link || ""} onChange={e => { handleChange(index, e.target.value, item.linktext) }} className='bg-white px-4 py-2 mx-2 my-2 focus:outline-blue-500 rounded-4xl' type="text" placeholder="Enter link text"></input>
                                <input value={item.linktext || ""} onChange={e => { handleChange(index, item.link, e.target.value) }} className='bg-white px-4 py-2 mx-2 my-2 focus:outline-blue-500 rounded-4xl' type="text" placeholder="Enter link"></input>
                            </div>
                        })}
                    ...
                    <div className="item">
                        ...
                        <div className='mx-4 flex flex-col'>
                            ...
                            <button onClick={() => { submitLinks() }} className='p-5 py-2 mx-2 my-5 bg-slate-900 text-white font-bold cursor-pointer rounded-3xl w-fit'>Create your Linktree</button>
                        </div>
                    </div>
                </div>
            </div>
